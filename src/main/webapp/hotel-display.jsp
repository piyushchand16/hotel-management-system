	...
	<table class="table align-middle mb-0 bg-white">
		...
		<tbody>
			<tr>
				...
				<%}%>
				<td><a href="#"><span class="badge badge-success rounded-pill d-inline" ">EDIT</span></a></td>
				<td><a href="hotelDelete?id=<%= hotel.getId()  %>"><span class="badge badge-danger rounded-pill d-inline" style="padding-left: 2px;">DELETE</span></a></td>
			</tr>
		</tbody>
		<%
		}
