        ...
        <div class="col-12 col-md-9 col-lg-7 col-xl-6">
          <div class="card" style="border-radius: 15px;">
            <div class="card-body p-5">
              ...
              <%} %>
              <form action="hotelOwnerRegister" method="post" autocomplete="off">
                ...
                <div data-mdb-input-init class="form-outline mb-4">
                  <input type="number" id="form3Example4cdg" name="phone" class="form-control form-control-lg" />
                  <label class="form-label" for="form3Example4cdg">Enter Phone No</label>
                </div>
